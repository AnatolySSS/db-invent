...
export const DescriptionIt = (props) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    serial: currentColumns.includes("serial") && Yup.string().required("Обязательное поле"),
            ...
            {currentColumns.includes("set_with") && (
              <div className="col-6">
                <Field
                  name="set_with"
                  component={InputFieldComponent}
                  title="Образует одно устройство"
                  dialogType={dialogType}
                  disabled={disabled}
                />
              </div>
