...
export const DescriptionIt = (props) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    serial: currentColumns.map((col) => col.field).includes("serial") && Yup.string().required("Обязательное поле"),
    serviceable:
        ...
        <div className="grid nested-grid">
          ...
          <div className="col-9">
            <div className="grid">
              ...
              {currentColumns.map((col) => col.field).includes("serial") && (
                <div className="col-6">
                  <Field
                    name="serial"
                    component={InputFieldComponent}
                    title={currentColumns.filter((col) => col.field === "serial")[0].header}
                    dialogType={dialogType}
                    disabled={disabled}
                  />
                </div>
          ...
          <div className="grid col-12">
            ...
            {currentColumns.map((col) => col.field).includes("ad_name") && (
              <div className="col-6">
                <Field
                  name="ad_name"
                  component={InputFieldComponent}
                  title={currentColumns.filter((col) => col.field === "ad_name")[0].header}
                  dialogType={dialogType}
                  disabled={disabled}
                />
              </div>
            ...
            {currentColumns.map((col) => col.field).includes("workplace_type") && (
              <div className="col-6">
                <Field
                  name="workplace_type"
                  component={DropdownFieldComponent}
                  title={currentColumns.filter((col) => col.field === "workplace_type")[0].header}
            ...
            {currentColumns.map((col) => col.field).includes("set_with") && (
              <div className="col-6">
                <Field
                  name="set_with"
                  component={InputFieldComponent}
                  title={currentColumns.filter((col) => col.field === "set_with")[0].header}
                  dialogType={dialogType}
                  disabled={disabled}
                />
              </div>
          ...
          <div className="grid col-12">
            ...
            {currentColumns.map((col) => col.field).includes("incoming_date") && (
              <div className="col-6">
                <Field
                  name="incoming_date"
                  component={CalendarFieldComponent}
                  title={currentColumns.filter((col) => col.field === "incoming_date")[0].header}
                  minDate={null}
                  dialogType={dialogType}
                  disabled={disabled}
                />
