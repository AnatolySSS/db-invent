  ...
  return (
    ...
    >
      <span className="p-input-icon-right p-float-label">
        ...
        {touched[field.name] && ((errors[field.name] && <i className="pi pi-exclamation-circle" style={{ color: "red" }} />) || <i className="pi pi-user" />)}
  ...
  return (
    <div className="h-screen flex align-items-center justify-content-center">
      <div ref={messageRef} className="flex flex-column">
        ...
        >
          <Form>
            <Field name="login" component={LoginInput} message={message} passwordMt={passwordMt} setPasswordMt={setPasswordMt} />
            <Field name="password" component={PasswordInput} message={message} passwordMt={passwordMt} setPasswordMt={setPasswordMt} />
            <div className="mb-2">{message && <Message style={{ width: messageRef.current.offsetWidth }} severity="error" text={message} />}</div>
